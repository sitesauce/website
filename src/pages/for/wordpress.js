		...
		<Layout>
			<div className="overflow-hidden">
				...
				<Features title="What's in it for me?" description="Enjoy all the benefits static sites provide while keeping the ease of editing WordPress gives you." cta="See pricing">
					...
					<FeatureItem title="Unbreakable Security" description="Without access to your WordPress site, there's no way for anyone to steal sensitive data or deface your website." icon={icons.Shield} />
				...
				<Pricing>
					...
					<PricingFeature>Official WordPress plugin</PricingFeature>
				</Pricing>
				<FAQ>
					<FAQEntry>
						<Question>
						...
						<Answer>
							<p>
								While it's recommended to keep your WordPress instance running somewhere (like a subdomain), as it allows you to continue using your dashboard regularly, you can deploy locally-running sites to Sitesauce using <a href="https://sitesauce.app/guides/cli">our CLI</a>!
							</p>
							<p>This means you could have your blog on your computer, run it locally to edit some content then push it to production via Sitesauce without needing to pay for servers!</p>
						</Answer>
					</FAQEntry>
					<FAQEntry>
						<Question>
						...
						<Answer>
							<p>Sitesauce provides an official WordPress plugin that automatically detects when your content changes and lets us know. Setting it up is as easy as searching for it on the WordPress plugin directory, clicking install and pasting a URL from your Sitesauce dashboard.</p>
							<p>We also allow you to define periodical deployments, which tell us to automatically deploy your site every day, hour or minute.</p>
						</Answer>
					</FAQEntry>
					<FAQEntry>
						<Question>
					...
					<FAQEntry>
						...
						<Answer>
							...
							<p>
								...
								over to WordPress. You can also use this if you need to fetch some data from your backend via AJAX.
							</p>
						</Answer>
					</FAQEntry>
					<FAQEntry>
						...
						<Answer>
							<p>
								Yes! More than {stats?.sitesauce?.sites} sites have been deployed using Sitesauce to date. Some examples include the <a href="https://branchci.com">Branch</a> website, which uses WordPress, and{' '}
