...
![Here's the name of your site](https://sitesauce.app/assets/vercel-site-select.png)
...
![Click the button to be taken to the domains page](https://sitesauce.app/assets/view-domains-button.png "left")
