			...
			<div className="relative">
				...
				<div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="max-w-4xl mx-auto">
						<Link href="/open">
							<a className="block group rounded-lg bg-brand-400 hover:bg-brand-500 overflow-hidden shadow-brand hover:shadow-brand-hover border-2 border-brand-400 hover:border-brand-500 transform hover:translate-x-1 hover:translate-y-1 transition duration-300 ease-in-out relative z-30">
