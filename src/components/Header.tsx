		...
		<>
			<div className="bg-brand-50 absolute inset-0 bottom-auto">
				<div className="relative flex items-center lg:items-start justify-between px-4 md:px-10 lg:px-0 mt-4 lg:mt-0 z-40">
					<a href="/">
						<div
							className="md:bg-white md:shadow-brand md:border-r-2 md:border-b-2 md:border-brand-100 md:py-4 md:px-4"
							aria-label="Sitesauce logo"
						>
							<svg className="h-8" viewBox="0 0 2022 287" xmlns="http://www.w3.org/2000/svg">
								<g fill="none" fillRule="evenodd">
									<g fillRule="nonzero" opacity=".76">
										...
										<path
											d="M91.808.332h8.692V96.25H0v-4.288C.06 41.347 41.142.344 91.808.332z"
											fill="#8ADDE4"
										/>
										<path
											d="M0 94.74h100.5v95.918h-5.042C42.738 190.658 0 147.954 0 95.276v-.536z"
											fill="#ACE7EB"
										/>
										<path
											d="M.75 190.765h100.5v95.811h-8.69c-50.705 0-91.81-41.026-91.81-91.635v-4.283.107z"
											fill="#CDF0F2"
										/>
										<path fill="#ACE7EB" d="M100.5 190.658H201v95.918H100.5z" />
										<path
											d="M199.5 190.658H300v4.283a91.547 91.547 0 01-26.89 64.796 91.9 91.9 0 01-64.92 26.84h-8.69v-95.919z"
											fill="#8ADDE4"
										/>
										<path
											d="M199.5 94.74h5.042c52.72 0 95.458 42.704 95.458 95.382v.536H199.5V94.74z"
											fill="#6AD4DD"
										/>
										<path
											d="M199.5.332h8.69C258.895.332 300 41.358 300 91.967v4.283H199.5V.332z"
											fill="#49CBD5"
										/>
									</g>
					...
					<div className="flex items-center z-100 relative">
						<div className="hidden lg:block shadow-brand bg-white border-l-2 border-r-2 border-b-2 border-brand-100 py-4 px-6 mr-4 space-x-6">
							{nav.map(([label, url]) => (
								<a key={label} href={url}>
									<a className="font-brown mx-auto relative text-left uppercase text-xs text-shadow text-brand-400">
										{label}
									</a>
								</a>
							))}
						...
						<div className="hidden lg:block shadow-brand-reverse bg-white border-l-2 border-b-2 border-brand-100 py-4 px-6">
							<a
								href="https://app.sitesauce.app/login"
								className="font-brown mx-auto relative pr-6 text-left uppercase text-xs text-shadow text-brand-400"
							>
								Login
							</a>
							<a
								href="https://app.sitesauce.app/register"
								className="font-brown mx-auto relative text-left uppercase text-xs text-shadow text-brand-400"
							>
								Get Started
							</a>
						</div>
					...
					<button
						...
						type="button"
						className="bg-brand-100 inline-flex lg:hidden items-center justify-center p-2 rounded-lg text-white shadow-brand hover:shadow-brand-hover transition duration-150 ease-in-out focus:outline-none border-2 border-brand-100 my-1 transform hover:translate-x-1 hover:translate-y-1 focus:translate-x-1 focus:translate-y-1"
				...
				<nav role="navigation" className="absolute top-0 inset-x-0 md:p-2 lg:hidden pr-2 md:ml-3 md:mr-5 z-40">
					...
					>
						<ClickAwayListener
							...
							className="rounded-r-lg md:rounded-lg shadow-md transition transform origin-top-right"
						>
							<div>
								<div className="rounded-lg bg-white shadow-brand overflow-hidden ">
									<div className="pl-4 pt-5 md:pl-5 px-5 md:pt-4 flex items-center justify-between">
										<div className="flex items-center">
											<svg
												className="w-48 h-auto text-brand-400"
												width="3953"
												height="617"
												viewBox="0 0 3953 617"
									...
									<div className="px-2 pt-2 pb-3 space-y-1">
										{nav.map(([label, url]) => (
											<a key={label} href={url}>
												<a
													...
													className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-brand-900 hover:bg-brand-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out font-ttnorms"
												>
													{label}
												</a>
											</a>
										...
										<a
											onClick={() => setOpen(false)}
											href="https://app.sitesauce.app/login"
											className="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-brand-900 hover:bg-brand-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out font-ttnorms"
										>
											Login
										</a>
									</div>
									<div>
										<a
											onClick={() => setOpen(false)}
											href="https://app.sitesauce.app/register"
											className="block w-full px-5 py-3 text-center font-medium text-brand-400 bg-brand-50 hover:text-brand-500 focus:outline-none focus:bg-gray-100 focus:text-brand-700 transition duration-150 ease-in-out font-ttnorms"
										>
											Get Started
										</a>
									</div>
